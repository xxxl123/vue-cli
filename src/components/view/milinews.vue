<template>
	<div>
		<div class="container">
		<el-container>
		  <el-header><h1>{{$store.state.milinewstitle}}</h1></el-header>
		  <el-main>
			  <div>
				  <div style="text-align: left;">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$store.state.milinewshead}}
				  </div>
				  <img src="../../assets/images/mili2/a.jpg" alt="">
				  <img src="../../assets/images/mili2/b.jpg" alt="">
				  <div style="text-align: left;">
				  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$store.state.milinewsmain}}
				  </div>
				  
				  <img src="../../assets/images/mili2/c.jpg" alt="">
				  <img src="../../assets/images/mili2/d.jpg" alt="">
				  <div style="text-align: left;">
				  					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$store.state.milinewsfooter}}
				  </div>	
			</div>
		  </el-main>
...
<script>
	export default {
		data(){
			return{
				pagemessages:this.$store.state.milinewsreview,
				name:"",
				content:"",
				list2:""
			}
